...
Ext.define('GestEstructure.controller.Estructures', {
    ...
    init: function() {
     ...
     onRender:function(){
        ...
        Interactive.show('syn.estructure.description');
    },
    ...
    add:function(button){
        ...
        var model=this.getEstructuretree().getSelectionModel().getLastSelected();
        if(win.action=='edit'){
            this.update(win.down('form'),'estructure/edit',model);
        }else{
            this.insert(win.down('form'),'estructure/insert',model);
        }
    },
