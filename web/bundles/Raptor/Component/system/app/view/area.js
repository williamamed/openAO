...
Panel.Ui.BootstrapArea = Backbone.View.extend({
    ...
    initialize: function() {
        ...
        this.listenTo(this.model, 'error', function(a,request){
                Panel.model.set({
			extjs: false,
			content:'<h1 style="font-size:50px;margin-top:50px;padding:30px;color: white;margin-bottom: 10px;font-size:90px"><span style="font-size:90px">): </span> '+request.status+'</h1><p class="text-center" style="padding-bottom: 50px">Ocurrió un problema cargando esta página.</p>'
		})
