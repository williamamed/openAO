...
//       this.grid=new Generator.Grid();
    ...
    questionModel:function(){
        ...
        var question="<div style='width: 200px;max-height:100px;overflow-y: auto;'><b>Para generar:</b><br><br>"+
                "<b>Tablas:</b> "+this.grid.getSelectionModel().getSelection().length+"<br><br>"+
               
                "<b>Tabla:</b> <br>"+Entities+"<br><br>"+
               "<b>Está seguro?</b></div>";
...
Ext.define('Generator.Grid',{
        ...
        region: 'center',
        iconCls: 'icon-table',
        title:'Generador de esquemas de Doctrine',
        
        columns: [
        
        {header: 'Clases Entidad', width: 200, flex: 1, dataIndex: 'class'},
