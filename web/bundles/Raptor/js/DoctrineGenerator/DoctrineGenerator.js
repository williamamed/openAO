...
Ext.define('Generator.Panel',{
    ...
    initComponent:function(){
        ...
        this.adicionar=new Ext.Button({disabled:true,iconCls: 'icon-add', text: 'Generar', handler: this.questionModel,scope:this});
...
//         this.grid.tbar=[this.adicionar,this.modificar,this.eliminar];
    ...
    questionModel:function(){
        ...
        var question="<div style='height:200px;overflow-y: auto;width:100%'><b>A generar:</b><br><br>"+
                "<b>Entidades:</b> "+this.grid.getSelectionModel().getSelection().length+"<br>"+
                "<b>Repositorios:</b> "+this.grid.getSelectionModel().getSelection().length+"<br>"+
                "<b>Directorio de entidades del componente:</b> <br>"+Entities+"<br>"+
                "<b>Directorio de repositorios del componente:</b> <br>"+Entities+"<br>"+
                "<b>Usaremos anotaciones, los métodos setter y </b> <br>"+
                "<b> getter son la mejor opción !!</b> <br><br>"+
                "<b>Está seguro?</b></div>";
    ...
    createModels:function(){
        ...
        var wait=Raptor.msg.show(4,'Por favor espere .....');
        Ext.Ajax.request({
            url: 'model/create',
            method: 'POST',
...
Ext.define('Generator.Grid',{
        ...
        region: 'center',
        iconCls: 'icon-table',
        title:'Generador de modelos de Doctrine',
        
        columns: [
        
        {header: 'Tablas', width: 200, flex: 1, dataIndex: 'table'}
