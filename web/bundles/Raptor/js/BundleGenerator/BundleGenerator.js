...
Ext.define('Generator.Panel',{
    ...
    initComponent:function(){
        ...
        this.adicionar = new Ext.Button({disabled: true,  iconCls: 'icon-add', text: 'Crear', handler: this.mostrarAdicionar, scope: this});
        this.exportar=new Ext.Button({disabled:true, iconCls: 'icon-zip', text: 'Exportar como Zip', handler: this.exporting,scope:this});
        this.eliminar = new Ext.Button({disabled: true, iconCls: 'icon-del', text: 'Eliminar', handler: this.eliminarOrganismo, scope: this});
//       this.grid=new Generator.Grid();
    ...
    eliminarOrganismo:function(){
        Raptor.msg.show(2,"Está a punto de eliminar este componente, está seguro?",this.deleteOrganismo,this);
    },
    ...
    exporting:function(){
        var me=this;
        var wait=Raptor.msg.wait('Espere un momento mientras verificamos el componente para exportar');
        Ext.Ajax.request({
    ...
    Ext.define('Generator.Window',{
        ...
        initComponent:function(){
            ...
            this.aceptar=new Ext.Button({ iconCls: 'icon-acept', text: 'Aceptar', handler: this.aceptar,scope:this});
            this.cancelar=new Ext.Button({ iconCls: 'icon-cancel', text: 'Cancelar', handler: this.cerrar,scope:this});
       ...
       createDefinition:function(){
           ...
           var definitionView='<b style="color:black">Definición del componente:&nbsp;&nbsp;<br></b><b style="color:black">\\</b><b style="color:green">'+vendor+'</b><b style="color:black">\\</b><b style="color:black">'+bundle+'</b><b style="color:blue">Bundle</b>';
        ...
        createFormulario:function(){
            ...
            items: [{
                   ...
                   enableKeyEvents:true,
                    ...
                    enableKeyEvents:true,
                    regex:/^[a-zA-Z0-9]+$/,
                    blankText: 'El componente necesita un nombre',
                     width:'100%',
                    anchor: '100%',
                    labelAlign: 'top',
                    name: 'bundle'
...
Ext.define('Generator.OutPut',{
    ...
    html:'<b style="color:gray">>> Ouput Console - Raptor 3</b>'
