...
Ext.define('Generator.Panel',{
    ...
    initComponent:function(){
        ...
        this.adicionar=new Ext.Button({disabled:true,iconCls: 'icon-add', text: 'Publicar', handler: this.publish,scope:this});
        this.deleteResour=new Ext.Button({disabled:true,iconCls: 'icon-clear', text: 'Limpiar', handler: this.eliminar,scope:this});
//       this.grid=new Generator.Grid();
    ...
    publish:function(){
        Raptor.msg.show(2,"Está a punto de publicar los recursos del componente seleccionado, está seguro?",this.create,this);
    },
    eliminar:function(){
        Raptor.msg.show(2,"Está a punto de limpiar los recursos del componente seleccionado, está seguro?",this.deleteResources,this);
    },
    create:function(){
        var me=this;
...
Ext.define('Generator.Tree', {
    ...
    title: 'Vendor/Bundle - Publicador de recursos web',
    width:400,
    margin:'0 5 0 0',
    region: 'west',
