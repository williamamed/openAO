...
Ext.define('Generator.Panel',{
    ...
    Ext.define('Generator.Window',{
        ...
        closeAction:'hide',
        layout:'fit',
        title:'Especifique el nombre de la platilla UI',
        initComponent:function(){
...
Ext.define('Generator.OutPut',{
    ...
    title:'Generador UI - <b style="color:gray;padding: 3px;">Construye las plantillas facilmente</b>',
    region:'center',
    id:'out-pan',
    disabled:true,
    header:true,
    initComponent:function(){
        ...
        this.on('render',function(){
            this.setLoading('Buscando plantillas ...');
            Ext.Ajax.request({
                url: 'genui/list',
                callback: function() {
