...
//        Raptor.controlActions();
    ...
    onUpdate: function() {
        var view = Ext.widget('viawindow', {action: 'edit',title:'Editar tipo de incidencia'});
    ...
    updateUser: function(button) {
        ...
        if (win.action == 'edit') {
            ...
            this.editUser(form, 'tipoincidencia/edit', record.get('id'));
        ...
        if (win.action == 'add') {
            ...
            var form = win.down('form');
           this.insertUser(form, 'tipoincidencia/insert');
    ...
    onDelete: function() {
        Raptor.msg.confirm("¿Está a punto de eliminar este elemento, está seguro?", this.deleteUser, this);
