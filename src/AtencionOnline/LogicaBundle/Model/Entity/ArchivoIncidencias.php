...
/**
 * AtencionOnline\LogicaBundle\Model\Entity\ArchivoIncidencias
 *
 * @Table(name="archivo_incidencias")
 * @Entity(repositoryClass="AtencionOnline\LogicaBundle\Model\Repository\ArchivoIncidenciasRepository")
 */
class ArchivoIncidencias
{
    /**
     * @var bigint $id
     *
