 ...
 */
namespace AtencionOnline\EscritorioBundle;
 ...
 * @Route("")
 */
class EscritorioBundle extends Bundle{

    public function registerBundleAspect(AspectContainer $appAspectContainer) {
//        $appAspectContainer->registerAspect(new Aspect\LogAspect());
    }
    ...
    public function registerRouteRule(RuleContainer $ruleContainer) {
        $ruleContainer->add('/portal[\/\w]*',  $this->app->getSecurity()->getManager());
