...
Ext.define('Ext.ux.desktop.TaskBar', {
    ...
    initComponent: function () {
       ...
       Ext.getBody().on('click',function(){
           ...
           if(myDesktopApp.getDesktop().getDesktopZIndexManager()){
               
                var front=myDesktopApp.getDesktop().getDesktopZIndexManager().front;
                    var z= parseInt(front.getEl().getStyle('z-index'))+1;
                    me.getEl().setStyle({
                        zIndex: z
                    });
                  
            }else{
                var front=me.startMenu;
                if(front.getEl())
                    var z= parseInt(front.getEl().getStyle('z-index'))+1;
                    me.getEl().setStyle({
                        zIndex: z
