        ...
        .controller("profileController", function ($scope, $http, $location,$routeParams,$templateCache) {
            ...
            $scope.submitForm = function (isValid) {
                ...
                if (isValid) {
                    ...
                    $http.post(Raptor.getRoute('/'+Raptor.ngPortal.route+'/profile/profiledata'), $scope.user, {ignoreRequest: true})
            ...
            $scope.submitPassForm = function (isValid) {
                ...
                if (isValid) {
                    ...
                    $http.post(Raptor.getRoute('/'+Raptor.ngPortal.route+'/profile/changepass'), $scope.userpass, {ignoreRequest: true})
                            .then(function (response) {
