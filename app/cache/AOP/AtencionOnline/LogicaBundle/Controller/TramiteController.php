 ...
 * @Route("/tramite")
 */
class TramiteController__AopProxied extends Controller{
...
include_once AOP_CACHE_DIR . '/_proxies/AtencionOnline\\LogicaBundle\\Controller\\TramiteController.php';
