 ...
 * @Route("/registro")
 */
class RegistroController__AopProxied extends Controller{
...
include_once AOP_CACHE_DIR . '/_proxies/AtencionOnline\\LogicaBundle\\Controller\\RegistroController.php';
