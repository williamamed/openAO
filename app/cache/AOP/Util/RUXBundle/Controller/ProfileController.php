 ...
 */
class ProfileController__AopProxied extends Controller {
    ...
    public function profileAction($request, $response, $route) {
        ...
        return $this->render('@RUXBundle/profile/userprofile.html.twig', array(
...
include_once AOP_CACHE_DIR . '/_proxies/Util\\RUXBundle\\Controller\\ProfileController.php';
